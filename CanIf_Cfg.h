...
/* Defines the number of can controllers in the underlying layer */
#define NUM_OF_CAN_CONTROLLERS 		 (1)

/* Defines the number of can transceivers in the underlying layer */
#define NUM_OF_CAN_TRCVS	 		 (1)
